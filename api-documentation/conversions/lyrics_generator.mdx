...
>**Note:** The prompt must be between 1 and 1000 characters.
...
```bash
curl -G "https://api.musicgpt.com/api/public/v1/prompt_to_lyrics" \
  --data-urlencode "prompt=A hopeful song about starting over" \
