...
**Music AI v2** is currently available only for enterprise users.
...
<p>Live Audio Streaming to the enterprise users. </p>
<p>Single Song per generation.</p>
</div>

>> To get the response of streaming, go to the endpoint [Get Conversion Details by Id Streaming](/api-documentation/endpoint/getByStreaming).
...
* **View the live streaming of the song**
