...
Input audio path: 
<audio controls="1" controlslist="nodownload nofullscreen noremoteplayback" src="https://musicgpt.s3.us-east-1.amazonaws.com/ApiDocumentationFiles/input_audio_sample_api_docs.m4a">Your browser does not support the audio playback.</audio>

Output:
<a href="https://musicgpt.s3.us-east-1.amazonaws.com/conversions/cover_sample.mp3" target="_blank">Download Audio</a>
...
```json
{
  ...
  "audio_url": "https://musicgpt.s3.us-east-1.amazonaws.com/projects/fa318903-41af-460b-9ab4-86d2c77bea46.wav",
