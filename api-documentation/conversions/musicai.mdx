...
---
<Warning>
  **Deprecation Notice:** Music AI v1 has been deprecated. Please use [Music AI v2](/api-documentation/conversions/musicaistreaming) for the latest features, model selection (`v6`, `v6-pro`, `v7`, `v7-pro`), improved performance, and better output quality.
</Warning>
