---
title: "Introduction"
description: "MusicGPT Public API -- turn any idea into production-ready audio with the world's most advanced AI models, through one simple API."
---
...
<div className="mg-hero">
  ...
  <div className="mg-hero-actions">
    ...
    <a href="https://musicgpt.com/api-dashboard" className="mg-btn mg-btn-ghost">
      <Icon icon="gift" iconType="solid" /> Get $20 free credits
    </a>
  </div>
</div>
